...
public class GameExample {
    ...
    private void loadDefaultQuestions() {
        ...
        questions.add(new Question.Builder("What is 2+2?")
        .addAnswer("4")
        .addAnswer("four")
        .addAnswer("a number")
        .build());
        questions.add(new Question.Builder("What is Colin's favorite color?")
        .addAnswer("blue"));
        questions.add(new Question.Builder("What is the air speed velocity of an unladen swallow?")
        .addAnswer("african or european?");
        .addAnswer("african or european");
        .addAnswer("what do you mean? is it an african or european swallow?"));
        questions.add(new Question.Builder("What gets wetter as it dries?")
        .addAnswer("towel");
        .addAnswer("towels");
        .addAnswer("a towel"));
    }
